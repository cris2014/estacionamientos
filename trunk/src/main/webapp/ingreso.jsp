...
<table width="780" border="0" cellspacing="2" cellpadding="2">
 ...
 <tr>
	...
	<table border="0" cellspacing="2" cellpadding="2" width="90%">
		...
		<tr>
		  <td colspan="3" ><div align="left" class="CeldaTitulo2">INGRESO ESTACIONAMIENTO</div>	</td>
	      </tr>
		<tr>
		...
		<tr>
	      ...
	      <td height="20" colspan="2" class="TextoFijo"><div align="left">13/06/2010 08:55:15 </div></td>
	      </tr>
		<tr>
		  <td class="TextoFijo"><div align="left">Usuario :</div></td>
		  <td height="20" colspan="2" class="TextoFijo"><div align="left">${usuario.codigo} - ${usuario.nombre} ${usuario.apellido}</div></td>
		  </tr>
		<tr>
