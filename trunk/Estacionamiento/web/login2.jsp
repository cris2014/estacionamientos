...
<!--	Mensajes de error -->
  ...
  <table width="500" border="0">
    ...
    <tr>
      ...
      <td align="left" valign="top">
        ...
        <input name="user" type="text" class="borde" id="user" size="30" />
                <input name="operacion" type="hidden" value="mantenimientoConsulta" id="operacion" />
	</td>
      <td valign="top">&nbsp;</td>
      <td>&nbsp;</td>
      </tr>
    <tr>
      <td height="20">&nbsp;</td>
      <td>&nbsp;</td>
      <td align="left"><img src="img/login_b.png" width="105" height="19" /></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      ...
      <td align="left">
        ...
        <input name="pwd" type="password" class="borde" id="pwd" size="30" />
   		</td>
      <td align="left">
