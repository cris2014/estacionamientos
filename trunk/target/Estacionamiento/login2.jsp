...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
 ...
 <tr>
	...
	&nbsp;<br />
	&nbsp;<br />
    <form id="form1" name="form1" method="post" action="LoginPasswordServlet">
          <div align="center">
	<table border="0" cellspacing="0" cellpadding="0" width="70%">
		...
		<tr>
		  <td class="TextoFijo">Clave : </td>
		  <td class="TextoFijo"><input type="text" name="txtIdClave" id="txtIdClave" /></td>
		  <td class="TextoFijo"><input type="submit"/></td>
		  </tr>
		<tr>
